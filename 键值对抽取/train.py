...
DATA_WITH_C_PATH = 'resume_train_20200121/all_data_word_to_tag_perfect_0226.txt'
#DATA_PERFECT_PATH = 'resume_train_20200121/all_data_word_to_tag_perfect_0226.txt'
DATA_PERFECT_PATH = 'resume_train_20200121/all_data_word_to_tag_perfect_0226.txt'
FINAL_DATA_PATH = 'word_to_tag.txt'
TRAIN_WORD_TO_TAG_PATH = 'supporting_document/train_word_to_tag_0223.json'
#TRAIN_JSON_PATH = 'resume_train_20200121/own_train_data.json'
#TRAIN_PDF_DIR = 'resume_train_20200121/pdf/'
TRAIN_JSON_PATH = 'resume_train_20200121/train_data.json'
TRAIN_PDF_DIR = 'resume_train_20200121/pdf'
...
def get_score_by_model(model, train_json_path, pdf_root_dir):
    ...
    with open('supporting_document/word_to_ix_add_unk_0219.json',encoding="utf-8") as j:
...
def train_and_val():
    ...
    best_model_save_path = 'model/model_best_0522.pth'
    max_score = 0
    stop_epoch = 1
    unimprove_time = 0
    val_json_path = '329/v/1.json'
    val_pdf_dir = 'val'
