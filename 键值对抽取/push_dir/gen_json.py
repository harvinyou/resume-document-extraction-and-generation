...
PDF_DIR = '0601/测试文档'
JSON_FILE_PATH = '0601/输出结果/0601输出pdf抽取的信息_使用模型.json'
...
EMBEDDING_DIM = 100
HIDDEN_DIM = 100
MODEL_PARM_PATH = 'model/model_100_all_data_perfect_0227.pth'
...
def gen_json(pdf_root_dir, json_file_path):
    ...
    word_to_ix_path = 'supporting_document/word_to_ix_add_unk_0219.json'
