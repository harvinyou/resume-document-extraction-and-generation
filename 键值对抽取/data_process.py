...
sample1_pdf_path = 'resume_train_20200121/pdf/0ac186229aa0.pdf'
sample2_pdf_path = 'resume_train_20200121/pdf/a0a9e29f84aa.pdf'

PDF_DIR = 'resume_train_20200121/pdf/'
PDF_TEST_DIR = 'resume_train_20200121/pdf_simple/'
CORPUS_PATH = 'resume_train_20200121/corpus.txt'

MODEL_SAVE_PATH = 'model/0416.model'

#OLD_JSON_PATH = 'supporting_document/[new] train_data_20200207.json'
OLD_JSON_PATH = 'resume_train_20200121/train_data.json'
NEW_JOSN_PATH = 'newtrain.json'

FINAL_DATA_PATH = 'word_to_tag.txt'
...
if __name__ == '__main__':
    ...
    pdf_dir = 'resume_train_20200121\pdf'
    tag_file_path = 'own_all_data_perfect_0401.json'
    #txt_path = 'resume_train_20200121/all_data_word_to_tag_perfect_0226.txt'
    txt_path = 'all_data_word_to_tag_perfect_0401.txt'
    tagging2txt_with_c(pdf_dir, tag_file_path, txt_path)

    save_file_path = 'own_all_data_without_space.json'
    #bulit_tag_json_without_space(tag_file_path, save_file_path)

    long_error_txt_path = 'long_text_error.txt'
    ori_tag_file_path = 'own_all_data_without_space.json'
    save_tag_file_path = 'own_all_data_perfect_0401.json'
